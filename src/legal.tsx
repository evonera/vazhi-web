...
export function PrivacyContent() {
  return <div className="legal-content">
    ...
    <p>Local content can be removed from the app. Shared links can be closed, and published guides can be withdrawn. Closing a link stops new recommendations; it does not automatically erase records already received. Some records, including moderation reports and billing records, may remain while needed to operate the service or meet applicable obligations. For access or deletion of account-associated cloud data, email <a href="mailto:hello@vazhi.app?subject=Vazhi%20privacy%20request">hello@vazhi.app</a>. We may need to verify that you control the account before acting on a request.</p>
